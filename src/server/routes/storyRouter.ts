    ...
    const metadataSchema = {
      ...
      properties: {
        ...
        memoryUpdates: {
          ...
          properties: {
            currentPowerStage: { type: "STRING" },
            newCharacters: { type: "ARRAY", items: { type: "OBJECT", properties: { name: { type: "STRING"}, role: { type: "STRING"}, description: { type: "STRING"}, relationshipToMC: { type: "STRING"}, status: { type: "STRING"}, powerLevel: { type: "STRING"}, faction: { type: "STRING"}, manifestationImportance: { type: "OBJECT", properties: { narrativeWeight: { type: "STRING" }, recurrence: { type: "BOOLEAN" }, ownership: { type: "BOOLEAN" }, plotRelevance: { type: "BOOLEAN" }, namedStatus: { type: "BOOLEAN" }, emotionalSignificance: { type: "BOOLEAN" }, powerSignificance: { type: "BOOLEAN" }, futureRelevance: { type: "BOOLEAN" } } } } } },
            ...
            newFactions: { type: "ARRAY", items: { type: "OBJECT", properties: { name: { type: "STRING"}, description: { type: "STRING"}, alignment: { type: "STRING"}, headquarters: { type: "STRING"}, status: { type: "STRING"}, manifestationImportance: { type: "OBJECT", properties: { narrativeWeight: { type: "STRING" }, recurrence: { type: "BOOLEAN" }, ownership: { type: "BOOLEAN" }, plotRelevance: { type: "BOOLEAN" }, namedStatus: { type: "BOOLEAN" }, emotionalSignificance: { type: "BOOLEAN" }, powerSignificance: { type: "BOOLEAN" }, futureRelevance: { type: "BOOLEAN" } } } } } },
            ...
            newLocations: { type: "ARRAY", items: { type: "OBJECT", properties: { name: { type: "STRING"}, description: { type: "STRING"}, realm: { type: "STRING"}, safetyLevel: { type: "STRING"}, manifestationImportance: { type: "OBJECT", properties: { narrativeWeight: { type: "STRING" }, recurrence: { type: "BOOLEAN" }, ownership: { type: "BOOLEAN" }, plotRelevance: { type: "BOOLEAN" }, namedStatus: { type: "BOOLEAN" }, emotionalSignificance: { type: "BOOLEAN" }, powerSignificance: { type: "BOOLEAN" }, futureRelevance: { type: "BOOLEAN" } } } } } },
            ...
            newArtifacts: { type: "ARRAY", items: { type: "OBJECT", properties: { name: { type: "STRING"}, description: { type: "STRING"}, tier: { type: "STRING"}, currentOwner: { type: "STRING"}, manifestationImportance: { type: "OBJECT", properties: { narrativeWeight: { type: "STRING" }, recurrence: { type: "BOOLEAN" }, ownership: { type: "BOOLEAN" }, plotRelevance: { type: "BOOLEAN" }, namedStatus: { type: "BOOLEAN" }, emotionalSignificance: { type: "BOOLEAN" }, powerSignificance: { type: "BOOLEAN" }, futureRelevance: { type: "BOOLEAN" } } } } } },
