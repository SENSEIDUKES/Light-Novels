...
import { ReaderCodexCollage } from './codex/ReaderCodexCollage';
import { ReaderCodexCharacters } from './codex/ReaderCodexCharacters';
import { ReaderCodexRelations } from './codex/ReaderCodexRelations';
import { ReaderCodexPower } from './codex/ReaderCodexPower';
import { ReaderCodexGlossary } from './codex/ReaderCodexGlossary';
import { ReaderCodexMysteries } from './codex/ReaderCodexMysteries';
import { ReaderCodexTimeline } from './codex/ReaderCodexTimeline';
import { ReaderCodexArtifacts } from './codex/ReaderCodexArtifacts';
import { ReaderCodexFactions } from './codex/ReaderCodexFactions';
import { ReaderCodexDashboards } from './codex/ReaderCodexDashboards';
import { ReaderCodexFate } from './codex/ReaderCodexFate';
            ...
            >
              ...
              <div className="mb-6">
                ...
                <input
                  ...
                  onKeyDown={(e) => {
                    if (e.key === 'Enter' && deleteInput === 'DELETE' && deletePrompt) {
