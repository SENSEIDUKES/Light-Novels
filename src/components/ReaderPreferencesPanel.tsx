...
function PreferenceGroup({ label, icon, children }: PreferenceGroupProps) {
  return (
    <fieldset className="space-y-2.5">
      <legend className="mb-2 flex items-center gap-2 text-[10px] font-sans font-medium uppercase tracking-[0.16em] text-neutral-400">
      ...
      <div className="relative mx-auto max-w-[1480px] space-y-4">
        ...
        <div className="grid items-start gap-4 lg:grid-cols-[minmax(190px,0.8fr)_minmax(190px,0.8fr)_minmax(0,2.6fr)]">
          <section className="space-y-6 rounded-xl border border-neutral-800 bg-[#070a0d]/80 p-4 shadow-[0_12px_40px_rgba(0,0,0,0.2)]">
            <PreferenceGroup label="Aura Font" icon={<Type size={13} />}>
            ...
            <PreferenceGroup label="Atmospheric Hue" icon={<Palette size={13} />}>
              <div className="grid gap-1.5">
          ...
          <section className="space-y-6 rounded-xl border border-neutral-800 bg-[#070a0d]/80 p-4 shadow-[0_12px_40px_rgba(0,0,0,0.2)]">
            <PreferenceGroup label="Visual Scale" icon={<Sliders size={13} />}>
              <div className="grid gap-1.5">
            ...
            <PreferenceGroup label="Visual Highlights" icon={<Eye size={13} />}>
              <div className="grid gap-1.5">
          ...
          <section className="rounded-xl border border-neutral-700/80 bg-[#070a0d]/85 p-5 shadow-[0_12px_50px_rgba(0,0,0,0.24)] sm:p-6">
            <div className="mb-7 flex items-center justify-between gap-4">
              <div className="flex items-center gap-2.5 text-portal">
                <Eye size={16} />
                ...
                <div className="grid gap-4 border-t border-neutral-800 p-4 sm:p-5 lg:grid-cols-2">
                  <div className="rounded-lg border border-neutral-800 bg-black/20 p-4">
                    <div className="mb-4 flex items-start gap-3">
                      <Sliders size={15} className="mt-0.5 text-portal" />
                      <div>
                        <h5 className="font-sans text-[10px] font-semibold uppercase tracking-[0.15em] text-neutral-200">Atmospheric Synthesis</h5>
                        <p className="mt-1 text-[10px] leading-relaxed text-neutral-500">Generative soundscapes that follow the chapter mood.</p>
                      </div>
                    </div>
                  ...
                  <div className="rounded-lg border border-neutral-800 bg-black/20 p-4">
                    <div className="mb-4 flex items-start gap-3">
                      <Music size={15} className="mt-0.5 text-portal" />
                      <div>
                        <h5 className="font-sans text-[10px] font-semibold uppercase tracking-[0.15em] text-neutral-200">Scene Score</h5>
                        <p className="mt-1 text-[10px] leading-relaxed text-neutral-500">Automatically follows the narrative, or pins a track for this session.</p>
                      </div>
                    </div>
