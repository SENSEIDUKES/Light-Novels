...
const PARTICLE_STYLE_OPTIONS = [
  { value: 'default', label: 'Celestial Embers (Classic)' },
  { value: 'sword_qi', label: 'Sword Qi Shards (Sharp)' },
  { value: 'lotus_blossom', label: 'Lotus Petals (Soft)' },
] as const;
