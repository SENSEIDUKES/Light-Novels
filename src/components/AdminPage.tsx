...
export default function AdminPage({ memory, onUpdateMemory }: AdminPageProps) {
            ...
            >
              ...
              <div className="mb-6">
                <div className="mb-2 flex items-center justify-between gap-2">
                  <label className="text-[10px] text-neutral-500 uppercase tracking-widest font-mono" htmlFor="a11y-control-yjtvc74">
