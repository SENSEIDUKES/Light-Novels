    ...
    >
      ...
      <div className="flex space-x-1 sm:space-x-2 items-center shrink-0">
        ...
        <button
          ...
          className={`p-2 rounded-full border flex items-center justify-center transition-all focus-visible:ring-2 focus-visible:ring-portal outline-none focus-visible:ring-offset-2 ${
        ...
        <button
          ...
          className={`p-2 rounded-full border flex items-center justify-center transition-all relative focus-visible:ring-2 focus-visible:ring-portal outline-none focus-visible:ring-offset-2 ${
            showBookmarksPanel
