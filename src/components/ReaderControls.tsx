                  ...
                  <div className="border-t border-neutral-900 pt-2 mt-1">
                    ...
                    {showVoiceDetail && (
                      <div className="space-y-2 mt-2 animate-fade-in text-neutral-400">
                        <div>
                          <label className="block text-[8px] text-neutral-500 mb-1" htmlFor="narrator-voice-mobile">
                            Narrator Voice
                          </label>
                          <select
                            id="narrator-voice-mobile"
                        ...
                        <div>
                          <label className="block text-[8px] text-neutral-500 mb-1" htmlFor="dialogue-voice-mobile">
                            Dialogue Voice
                          </label>
                          <select
                            id="dialogue-voice-mobile"
                    ...
                    <div className="border-t border-neutral-900 pt-2 mt-2">
                      ...
                      {showVoiceDetail && (
                        <div className="space-y-2.5 mt-2 animate-fade-in text-neutral-400">
                          <div>
                            <label className="block text-[9px] text-neutral-500 mb-1" htmlFor="narrator-voice-desktop">
                              Narrator Voice
                            </label>
                            <select
                              id="narrator-voice-desktop"
                              value={selectedVoiceURI}
                              onChange={(e) => setSelectedVoiceURI(e.target.value)}
                              className="w-full bg-void border border-neutral-850 rounded text-[10px] p-1 focus:border-portal focus:outline-none"
                            >
                          ...
                          <div>
                            <label className="block text-[9px] text-neutral-500 mb-1" htmlFor="dialogue-voice-desktop">
                              Dialogue Voice
                            </label>
                            <select
                              id="dialogue-voice-desktop"
                              value={selectedDialogueVoiceURI}
                              onChange={(e) => setSelectedDialogueVoiceURI(e.target.value)}
                              className="w-full bg-void border border-neutral-850 rounded text-[10px] p-1 focus:border-portal focus:outline-none"
                            >
          ...
          <div className="flex items-center justify-end gap-4 w-full sm:w-auto mt-4 sm:mt-0">
            ...
            <div className="flex items-center space-x-2 sm:space-x-4 bg-void border border-neutral-900 rounded-full px-2 py-1">
              <button
                 tabIndex={0} onKeyDown={(e) => { if (e.key === "Enter" || e.key === " ") { e.preventDefault(); e.currentTarget.click(); } }} onClick={navigatePrev}
                disabled={selectedChapterNum <= 1}
                className="px-2 sm:px-3 py-1.5 flex items-center space-x-1.5 text-neutral-400 hover:text-portal disabled:opacity-25 disabled:pointer-events-none transition-colors text-[9px] sm:text-[10px] font-sc uppercase tracking-wider font-semibold"
              >
                <ArrowLeft size={14} />
              ...
              <button
                ...
                className="px-2 sm:px-3 py-1.5 flex items-center space-x-1.5 text-neutral-400 hover:text-portal transition-colors text-[9px] sm:text-[10px] font-sc uppercase tracking-wider"
              >
                <ListMusic size={14} />
              ...
              <button
                 tabIndex={0} onKeyDown={(e) => { if (e.key === "Enter" || e.key === " ") { e.preventDefault(); e.currentTarget.click(); } }} onClick={navigateNext}
                disabled={selectedChapterNum === maxChapterNum}
                className="px-2 sm:px-3 py-1.5 flex items-center space-x-1.5 text-neutral-400 hover:text-human disabled:opacity-25 disabled:pointer-events-none transition-colors text-[9px] sm:text-[10px] font-sc uppercase tracking-wider font-semibold"
              >
            ...
            {handleAlterFate && (
              <button
                ...
                className="px-4 py-2 border border-portal text-portal font-sc font-bold uppercase tracking-wider text-[10px] rounded-full hover:bg-portal hover:text-void transition-colors flex items-center gap-2 shadow-[0_0_10px_rgba(4,172,255,0.15)] shrink-0"
              >
                <Zap size={14} />
