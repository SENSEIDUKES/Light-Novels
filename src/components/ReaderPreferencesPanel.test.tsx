...
describe('ReaderPreferencesPanel', () => {
  ...
  it('allows customizing the particles style and triggers updates', async () => {
    const handleUpdatePreference = vi.fn();
    render(
      <ReaderPreferencesPanel
    ...
    const particlesToggle = screen.getByRole('button', { name: /Particles Style/i });
    expect(particlesToggle.getAttribute('aria-expanded')).toBe('true');
