...
describe('ReaderPreferencesPanel', () => {
  ...
  it('allows customizing the particle formation style and triggers updates', async () => {
    const handleUpdatePreference = vi.fn();
    render(
      <ReaderPreferencesPanel
    ...
    const particleToggle = screen.getByRole('button', { name: /Particle Formation/i });
    expect(particleToggle.getAttribute('aria-expanded')).toBe('true');
